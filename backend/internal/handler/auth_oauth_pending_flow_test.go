...
func (r *oauthPendingFlowRedeemCodeRepo) ListWithFilters(context.Context, pagination.PaginationParams, service.RedeemCodeListFilters) ([]service.RedeemCode, *pagination.PaginationResult, error) {
