...
var DefaultModels = []Model{
	{ID: "gpt-5.6-sol", Object: "model", Created: 1780876800, OwnedBy: "openai", Type: "model", DisplayName: "GPT-5.6 Sol", ReasoningEfforts: []string{"none", "low", "medium", "high", "xhigh", "max"}},
	{ID: "gpt-5.6", Object: "model", Created: 1780876800, OwnedBy: "openai", Type: "model", DisplayName: "GPT-5.6 (Sol)", ReasoningEfforts: []string{"none", "low", "medium", "high", "xhigh", "max"}},
	{ID: "gpt-5.6-terra", Object: "model", Created: 1780876800, OwnedBy: "openai", Type: "model", DisplayName: "GPT-5.6 Terra", ReasoningEfforts: []string{"none", "low", "medium", "high", "xhigh", "max"}},
	{ID: "gpt-5.6-luna", Object: "model", Created: 1780876800, OwnedBy: "openai", Type: "model", DisplayName: "GPT-5.6 Luna", ReasoningEfforts: []string{"none", "low", "medium", "high", "xhigh", "max"}},
	{ID: "gpt-5.5", Object: "model", Created: 1776873600, OwnedBy: "openai", Type: "model", DisplayName: "GPT-5.5", ReasoningEfforts: []string{"none", "low", "medium", "high", "xhigh"}},
	{ID: "gpt-5.4", Object: "model", Created: 1738368000, OwnedBy: "openai", Type: "model", DisplayName: "GPT-5.4", ReasoningEfforts: []string{"none", "minimal", "low", "medium", "high", "xhigh"}},
	{ID: "gpt-5.4-mini", Object: "model", Created: 1738368000, OwnedBy: "openai", Type: "model", DisplayName: "GPT-5.4 Mini", ReasoningEfforts: []string{"none", "low", "medium", "high", "xhigh"}},
	{ID: "gpt-5.3-codex-spark", Object: "model", Created: 1735689600, OwnedBy: "openai", Type: "model", DisplayName: "GPT-5.3 Codex Spark", ReasoningEfforts: []string{"minimal", "low", "medium", "high"}},
	{ID: "codex-auto-review", Object: "model", Created: 1776902400, OwnedBy: "openai", Type: "model", DisplayName: "Codex Auto Review", ReasoningEfforts: []string{"none", "low", "medium", "high", "xhigh"}},
	{ID: "gpt-5.2", Object: "model", Created: 1733875200, OwnedBy: "openai", Type: "model", DisplayName: "GPT-5.2", ReasoningEfforts: []string{"none", "minimal", "low", "medium", "high", "xhigh"}},
