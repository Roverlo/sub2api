...
func (s *redeemCodeRepoStub) ListWithFilters(context.Context, pagination.PaginationParams, RedeemCodeListFilters) ([]RedeemCode, *pagination.PaginationResult, error) {
