...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: 'ApiGuide',
    alias: '/guide',
    component: () => import('@/views/public/ApiGuideView.vue'),
    meta: {
      requiresAuth: false,
      title: 'GPT API 使用说明',
    }
...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/key-usage', '/gpt-api-guide', '/guide', '/setup', '/payment/result', '/payment/airwallex', '/legal']
